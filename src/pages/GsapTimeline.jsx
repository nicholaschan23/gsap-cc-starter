  ...
  return (
    <main>
      ...
      <p className="mt-5 text-gray-500">
        ...
        <code>gsap.from()</code>, and <code>gsap.fromTo()</code> methods, but the
        difference is that the <code>gsap.timeline()</code> method is used to create a
        timeline instance that can be used to manage multiple animations, while the{" "}
        <code>gsap.to()</code>, <code>gsap.from()</code>, and <code>gsap.fromTo()</code>{" "}
        methods are used to animate elements from their current state to a new state, from
        a new state to their current state, and from a new state to a new state,
        respectively.
      </p>
